...
export const editUser = (userId, user) =>
  axios.put(`${API_URL}/users/${userId}`, user);
...
export const editAppointment = (appointmentId, appointment) =>
  axios.put(`${API_URL}/appointments/${appointmentId}`, appointment);
...
export const addsession = (session) =>
  axios.post(`${API_URL}/session`, session);
export const editsession = (sessionid, session) =>
  axios.put(`${API_URL}/session/${sessionid}`, session);
export const deletesession = (sessionid) =>
  axios.delete(`${API_URL}/session/${sessionid}`);

//scheduleapi
export const fetchschedule = () => axios.get(`${API_URL}/schedule `);
export const addschedule = (schedule) =>
  axios.post(`${API_URL}/schedule `, schedule);
export const eidtschedule = (scheduleid, schedule) =>
  axios.put(`${API_URL}/schedule/${scheduleid}`, schedule);
...
export const eidtreview = (reviewid, review) =>
  axios.put(`${API_URL}/review/${reviewid}`, review);
...
export const addinvoice = (invoice) =>
  axios.post(`${API_URL}/invoice `, invoice);
export const editinvoice = (invoiceid, invoice) =>
  axios.put(`${API_URL}/invoice/${invoiceid}`, invoice);
export const deleteinvoice = (invoice) =>
  axios.delete(`${API_URL}/invoice/${invoice}`);

//inventoryapi
export const fetchinventory = () => axios.get(`${API_URL}/inventory `);
export const addinventory = (invoice) =>
  axios.post(`${API_URL}/inventory `, inventory);
export const editinventory = (inventoryid, invoice) =>
  axios.put(`${API_URL}/inventory/${inventoryid}`, inventory);
export const deleteinventory = (inventory) =>
  axios.delete(`${API_URL}/inventory/${inventory}`);

//appointment api
export const fetchappointment = () => axios.get(`${API_URL}/appointment `);
export const addappointment = (appointment) =>
  axios.post(`${API_URL}/appointment `, appointment);
export const editappointment = (appointmentid, appointment) =>
  axios.put(`${API_URL}/appointment/${appointmentid}`, appointment);
export const deleteappointment = (appointment) =>
  axios.delete(`${API_URL}/appointment/${appointment}`);
